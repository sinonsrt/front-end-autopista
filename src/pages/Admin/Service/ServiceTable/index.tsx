...
import ServiceLogo from "../../../../assets/icons/service-logo.svg"
...
const ServiceTable: React.FC = () => {
  ...
  const columns = [
    { description: "Descrição", width: "50%" },
    { description: "Tipo", width: "50%" },
  ...
  return (
    <>
      ...
      <Typography variant="h5" display="initial" align="center" className={classes.titleLogo}> <img src={ServiceLogo} alt="Logotipo empresarial" /> Serviços cadastradas</Typography>
      <p />
