...
const ServiceTable: React.FC = () => {
  ...
  const [data, setData] = useState([
    {
      id: "uuid1",
      title: "5 firsts: Five milestones in the oil and gas industry",
      date: "24-05-2021",
      
    },
    {
      id: "uuid1",
      title: "Petrobras closes 2020 with a net profit of US$ 1,1 billion",
      date: "24-05-2021",
  ...
  return (
    <>
      ...
      <Typography variant="h5" display="initial" align="center" className={classes.titleLogo}> <img src={NewsLogo} alt="Logotipo empresarial" /> Serviços cadastradas</Typography>
      <p />
